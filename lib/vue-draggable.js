...
var VueDraggableMethods = {
  ...
  registerListeners: function registerListeners(el) {
    ...
    el.addEventListener('dragenter', function (e) {
      ...
      if (typeof _this.defaultOptions.onDragenter === 'function') {
        _this.defaultOptions.onDragenter(_extends({
          nativeEvent: e,
          stop: _this.stopDragAndDrop
        }, _this.selections));
      }
    ...
    el.addEventListener('dragleave', function (e) {
      ...
      if (droptarget !== _this.selections.droptarget) {
        ...
        if (typeof _this.defaultOptions.onDragleave === 'function') {
          _this.defaultOptions.onDragleave(_extends({
            nativeEvent: e,
            stop: _this.stopDragAndDrop
          }, _this.selections));
        }
    ...
    el.addEventListener('dragover', function (e) {
      ...
      if (typeof _this.defaultOptions.onDragover === 'function') {
        _this.defaultOptions.onDragover(_extends({
          nativeEvent: e,
          stop: _this.stopDragAndDrop
        }, _this.selections));
      }
